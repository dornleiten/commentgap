...
# Keep the legacy translations explicit rather than positional.  Unmapped
# categories stay in their stored form until a translation is agreed.
legacy_genre_labels <- c(
...
article_genres$genre1_eng <- unname(legacy_genre_labels[as.character(article_genres$genre1)])
missing_genre_labels <- is.na(article_genres$genre1_eng)
article_genres$genre1_eng[missing_genre_labels] <- as.character(article_genres$genre1[missing_genre_labels])
